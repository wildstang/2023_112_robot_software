...
public final class ArmConstants{
    ...
    // Physical constants
    public static final double MASS = 11.816 * 4.448;  // Newtons
    public static final double COM = 19.975 * .0254; // arm center of mass, meters
    ...
    public static final double SUBSTATION_POS = 0.99;
